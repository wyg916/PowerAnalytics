...
EXPECTED_RELEASE_ROOT = (PROJECT_ROOT / ".runtime" / "rag" / "releases" / "RAG-R1").resolve()
...
def _load_bm25(root: Path | None = None) -> dict[str, Any]:
    resolved = (root or EXPECTED_RELEASE_ROOT).resolve()
