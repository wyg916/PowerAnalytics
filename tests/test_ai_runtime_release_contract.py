...
def test_registry_routes_three_providers_and_requires_explicit_premium(monkeypatch):
    monkeypatch.setenv("MIMO_STABLE_MODEL_ID", "mimo-configured")
    monkeypatch.setenv("DEEPSEEK_STABLE_MODEL_ID", "deepseek-configured")
    monkeypatch.setenv("KIMI_STABLE_MODEL_ID", "kimi-configured")
